...
function exp_V86_TRONCONS_1rule0_eval_expression(context) {
    // TYPEVOIRIE = 'VV' AND Existant = 0

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('TYPEVOIRIE')  == 'VV') && (feature.get('Existant')  == 0));
    } else {
        return ((feature.get('TYPEVOIRIE')  == 'VV') && (feature.get('Existant')  == 0));
    }
}
...
function exp_V86_TRONCONS_1rule1_eval_expression(context) {
    // TYPEVOIRIE = 'VV' AND Existant = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('TYPEVOIRIE')  == 'VV') && (feature.get('Existant')  == 1));
    } else {
        return ((feature.get('TYPEVOIRIE')  == 'VV') && (feature.get('Existant')  == 1));
    }
}
...
function exp_V86_TRONCONS_1rule2_eval_expression(context) {
    // TYPEVOIRIE = 'VP' AND V86_01 = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('TYPEVOIRIE')  == 'VP') && (feature.get('V86_01')  == 1));
    } else {
        return ((feature.get('TYPEVOIRIE')  == 'VP') && (feature.get('V86_01')  == 1));
    }
}
...
function exp_v86_Haltes_Aires_valideesGpTravailElargi_mai2026_3rule0_eval_expression(context) {
    // type = 'Aire de services'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('type')  == 'Aire de services');
    } else {
        return (feature.get('type')  == 'Aire de services');
    }
}
...
function exp_v86_Haltes_Aires_valideesGpTravailElargi_mai2026_3rule1_eval_expression(context) {
    // type = 'Halte-repos'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('type')  == 'Halte-repos');
    } else {
        return (feature.get('type')  == 'Halte-repos');
    }
}